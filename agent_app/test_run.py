...
async def main() -> None:
    ...
    print(f"Connecting to Azure OpenAI at {endpoint} with model {deployment_name}")
    print(f"Connecting to Codemode MCP at {codemode_mcp_url}")
    ...
    async with (
        ...
        print(f"MCP tool connected: {storage_tool.name}")
        ...
        prompt = "List all containers in the storage account."
